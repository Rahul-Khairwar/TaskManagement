...
const Registration = async(req,res)=>{
   ...
   res.send({msg:"Data Save!",myData:UserData});
}
...
const createUser=async(req, res)=>{
   ...
   res.send({msg:"data save",mydata:userpss})
  
   var transporter = nodemailer.createTransport({
  service: 'gmail',
  auth: {
    user: 'rahulkhairwar01@gmail.com',
    pass: 'ggkx ywav iefx pegp'
  }
});
...
var mailOptions = {
  from: 'rahulkhairwar01@gmail.com',
  to: email,
